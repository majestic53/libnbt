...
tag: byte_array_tag.o byte_tag.o compound_tag.o double_tag.o end_tag.o float_tag.o generic_tag.o int_tag.o list_tag.o long_tag.o short_tag.o string_tag.o
